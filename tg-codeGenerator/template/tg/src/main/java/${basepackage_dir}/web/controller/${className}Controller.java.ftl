...
public class ${table.className}Controller extends TgSpringBaseController {
    private static final String LIST_PAGE = "pages/modules/${table.classNameFirstLower}/list";
    private static final String ADD_PAGE = "pages/modules/${table.classNameFirstLower}/add";
    private static final String EDIT_PAGE = "pages/modules/${table.classNameFirstLower}/edit";
    private static final String SHOW_PAGE = "pages/modules/${table.classNameFirstLower}/show";
    @Autowired
