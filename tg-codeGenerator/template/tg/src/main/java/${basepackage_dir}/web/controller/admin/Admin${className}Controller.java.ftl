...
/**
 * 后台：[${table.className}]Controller   ${table.remarks!""}
 */
@Controller
@RequestMapping("/tg/admin/${table.classNameFirstLower}")
public class Admin${table.className}Controller extends TgSpringBaseController {
    private static final String LIST_PAGE = "admin/modules/${table.classNameFirstLower}/list";
    private static final String ADD_PAGE = "admin/modules/${table.classNameFirstLower}/add";
    private static final String EDIT_PAGE = "admin/modules/${table.classNameFirstLower}/edit";
    private static final String SHOW_PAGE = "admin/modules/${table.classNameFirstLower}/show";
    @Autowired
     ...
     */
    @RequestMapping(value = "/findByPage.gsp")
    @ResponseBody
     ...
     */
    @RequestMapping(value = "/findAll.gsp")
    @ResponseBody
     ...
     */
    @RequestMapping(value = "/findEnabled.gsp")
    @ResponseBody
     ...
     */
    @RequestMapping(value = "/getByCodeNum.gsp")
    @ResponseBody
     ...
     */
    @RequestMapping(value = "/delete_{id}.gsp")
    @ResponseBody
     ...
     * 启用[${table.className}]
     */
    @RequestMapping(value = "/enable_{id}.gsp")
    @ResponseBody
     ...
     * 停用[${table.className}]
     */
    @RequestMapping(value = "/disable_{id}.gsp")
    @ResponseBody
